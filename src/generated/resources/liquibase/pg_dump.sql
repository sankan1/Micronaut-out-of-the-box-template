...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-person-table', 'sander', 'changelog/structure/2-person-table.sql', NOW(), 2, '9:f555528fa823edf1d4330f605159d538', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('create-user', 'sander', 'changelog/structure/4-user.sql', NOW(), 5, '9:a7d5136b6886387b5f1498fcd2572878', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('create-user-role', 'sander', 'changelog/structure/4-user.sql', NOW(), 6, '9:fe9d0c69b10a2ba343f735f9a86b70c4', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('make-ssn-nullable', 'sander', 'changelog/structure/6-make-ssn-nullable.sql', NOW(), 8, '9:6b669defaede961f06724e2b04aae7da', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-insurance-table', 'sander', 'changelog/structure/13-insurance-table.sql', NOW(), 15, '9:65bfa5842a31ba4912029a03956f4e17', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-insurance-expiring-soon-view', 'sander', 'changelog/structure/14-insurance-expiring-soon-view.sql', NOW(), 16, '9:368df0f6370ddcdbaf2d21ab6e463fb0', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-person-search-index', 'sander', 'changelog/structure/15-search-indexes.sql', NOW(), 17, '9:a75974d44da9c2d40a21b2adb513dc6e', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-car-search-index', 'sander', 'changelog/structure/15-search-indexes.sql', NOW(), 18, '9:cd6450efdd86def83032b2753e243dae', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-issuer-firm-search-index', 'sander', 'changelog/structure/15-search-indexes.sql', NOW(), 19, '9:0f665d23db7fb5220d0db2a4445e088c', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-insurance-search-index', 'sander', 'changelog/structure/15-search-indexes.sql', NOW(), 20, '9:bfd6247ff456963ae1a62eedfef6140b', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');

-- Changeset changelog/structure/16-document-schema.sql::add-document-schema::sander
CREATE SCHEMA document;

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-document-schema', 'sander', 'changelog/structure/16-document-schema.sql', NOW(), 21, '9:7cb3338e8de88cc1a8fd62b449feb5a3', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');

-- Changeset changelog/structure/17-document-table.sql::add-document-table::sander
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-document-table', 'sander', 'changelog/structure/17-document-table.sql', NOW(), 22, '9:26920b9d3da55affed682d77241e6e13', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');

-- Changeset changelog/structure/17-document-table.sql::add-document-search-index::sander
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('add-document-search-index', 'sander', 'changelog/structure/17-document-table.sql', NOW(), 23, '9:9bac872513d5f6323997916c8e16bbf1', 'sql', '', 'EXECUTED', NULL, NULL, '4.29.2', '3681542252');
