...
public class UserRole extends TableImpl<UserRoleRecord> {
    ...
    /**
     * The reference instance of <code>system.user_role</code>
     */
    ...
    /**
     * The column <code>system.user_role.user_role_id</code>.
     */
    public final TableField<UserRoleRecord, Long> USER_ROLE_ID = createField(DSL.name("user_role_id"), SQLDataType.BIGINT.nullable(false).generatedAlwaysAsIdentity(), this, "");

    /**
     * The column <code>system.user_role.user_id</code>.
     */
    public final TableField<UserRoleRecord, Long> USER_ID = createField(DSL.name("user_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>system.user_role.role</code>.
     */
    public final TableField<UserRoleRecord, String> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR(100).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>system.user_role</code> table reference
     */
    ...
    /**
     * Create a <code>system.user_role</code> table reference
     */
    public UserRole() {
    ...
    public UniqueKey<UserRoleRecord> getPrimaryKey() {
        return Keys.USER_ROLE__USER_ROLE_ID__PKEY;
    }

    @Override
    public List<UniqueKey<UserRoleRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.USER_ROLE__USER_ID_ROLE__UIDX);
    }

    @Override
    public List<ForeignKey<UserRoleRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USER_ROLE__USER_ROLE__USER_ID__FKEY);
    }
    ...
    public UserPath user() {
        if (_user == null)
            _user = new UserPath(this, Keys.USER_ROLE__USER_ROLE__USER_ID__FKEY, null);
